        ...
        <div className="fixed left-0 top-0 h-full w-64 bg-white shadow-lg">
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-semibold text-sm">CHECKNF</span>
            </div>
        ...
        <div className="flex flex-col w-64 bg-white shadow-lg border-r">
          ...
          <div className="flex items-center justify-center p-6 border-b">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-bold text-lg">CHECKNF</span>
            </div>
          </div>
            ...
            {filteredMenuItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  to={item.path}
                  className={cn(
                    "flex items-center gap-3 px-3 py-2 rounded-lg mb-1 transition-colors w-full",
                    location.pathname === item.path
                      ? "bg-green-100 text-green-700"
                      : "text-gray-600 hover:bg-gray-100"
                  )}
